...
type Props = { competencies: Competency[] }

export async function Competencies({ competencies }: Props) {
  ...
  return (
    <section className="container section" style={{ borderTop: 'var(--border-width) solid var(--color-border)' }}>
      <p className="text-label" style={{ marginBottom: '2.5rem' }}>{t('competencies_label')}</p>
